        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-0 lg:gap-40">
          ...
          <div className="w-full sm:w-[90%] md:w-[440px] h-auto sm:h-[410px] mx-auto lg:mx-0 space-y-4 sm:space-y-6  p-4 sm:p-6 md:mr-12 lg:mr-0  rounded-xl border border-gray-800/50">
            ...
            <div>
             ...
             طبقه ۱۶ جاییه که میشینی، یه چای می‌ریزی و گوش می‌دی به حرفای آدمایی که از دل تجربه‌های واقعی و مسیرهای پرچالش اومدن؛ چیزایی که معمولاً کسی راحت حرفشونو نمی‌زنه. تو هر قسمت بدون شعار و بدون قاطی‌پاتی، می‌ریم سراغ آدم‌ها و ایده‌هایی که ارزش شنیدن دارن. اینجا برای کساییه که از حرفای تکراری خسته شدن و دوست دارن با یه زاویه‌ی تازه به زندگی، کار و دغدغه‌های روزمره نگاه کنن.
