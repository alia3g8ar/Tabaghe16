        ...
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-0 lg:gap-40">
          ...
          <div className="w-full sm:w-[90%] md:w-[440px] h-auto sm:h-[410px] mx-auto lg:mx-0 space-y-4 sm:space-y-6  p-4 sm:p-6 md:mr-12 lg:mr-0  rounded-xl border border-gray-800/50">
            ...
            <div>
             ...
             طبقه ۱۶ جایی است برای شنیدن گفت‌وگوهایی که از تجربه‌های واقعی، مسیرهای پرچالش و اتفاق‌هایی شکل گرفته‌اند که معمولاً کمتر درباره‌شان حرف زده می‌شود. در هر قسمت تلاش می‌کنیم بدون شعار و پیچیدگی، سراغ آدم‌ها، ایده‌ها و موضوعاتی برویم که ارزش شنیدن و فکر کردن دارند. این پادکست برای کسانی ساخته شده که از شنیدن روایت‌های تکراری خسته شده‌اند و دوست دارند با زاویه‌ای تازه به زندگی، کار، انتخاب‌ها و دغدغه‌های روزمره نگاه کنند. 
